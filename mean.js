window.filterProducts = function(category, event, pageSectionId) {
    ...
    grid.innerHTML = ""; 
    const config = {
        'thoi-trang-nam': { allKeys: ['tshirts', 'pants', 'jackets'], map: { 'ao-thun': 'tshirts', 'quan-jean': 'pants', 'ao-khoac-jean': 'jackets' }},
        'thoi-trang-nu': { allKeys: ['blouses', 'skirts', 'womenJeans'], map: { 'ao-kieu': 'blouses', 'chan-vay': 'skirts', 'quan-jean': 'womenJeans' }}
    };
...
window.updateCartDisplay = function() {
    const cartDisplay = document.querySelector('[title="Giỏ hàng"] + span');
    if (cartDisplay) {
